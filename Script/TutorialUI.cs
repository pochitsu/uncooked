...
public class TutorialUI : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI gamepadKeyInteractAltText;
    ...
    private void UpdateVisual()
    {
        ...
        gamepadKeyInteractAltText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Gamepad_InteractAlternate);
