...
public class Player : MonoBehaviour, IKitchenObjectParent {
    ...
    public static Player Instance { get; private set; } //this is a property for singleton

    public event EventHandler OnPickedSomething; 
    public event EventHandler<OnSelectedCounterChagedEventArgs> OnSelectedCounterChanged;
    public class OnSelectedCounterChagedEventArgs : EventArgs {
    ...
    private void SetSelectedCounter(BaseCounter selectedCounter) {
        ...
        OnSelectedCounterChanged?.Invoke(this, new OnSelectedCounterChagedEventArgs
        {
